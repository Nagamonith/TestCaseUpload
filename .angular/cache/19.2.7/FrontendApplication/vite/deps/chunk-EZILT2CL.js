...
var DeferredObj = function() {
  ...
  deferredConfig.forEach(function(config2) {
    ...
    this._promise[config2.handler] = function(handler) {
      ...
      const callbacks3 = that[`${methodName}Callbacks`];
      if (callbacks3.fired()) {
...
deferredConfig.forEach(function(config2) {
  ...
  DeferredObj.prototype[`${methodName}With`] = function(context, args) {
    const callbacks3 = this[`${methodName}Callbacks`];
...
var DxTemplateDirective = class _DxTemplateDirective {
  ...
  name;
  constructor(templateRef, viewContainerRef, templateHost, renderer3, zone) {
...
function extractTemplate(option, element, renderer3, document2) {
  ...
  option.template = {
    render: (renderData) => {
      ...
      if (renderData.container) {
        ...
        renderer3.appendChild(container, element.nativeElement);
...
devextreme-angular/fesm2022/devextreme-angular-core.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-EZILT2CL.js.map
